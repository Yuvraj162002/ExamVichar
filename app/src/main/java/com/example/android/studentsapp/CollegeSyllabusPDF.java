...
import com.example.android.studentsapp.databinding.ActivityCollegeSyllabusPdfBinding;
...
public class CollegeSyllabusPDF extends AppCompatActivity {

    ActivityCollegeSyllabusPdfBinding bind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind = ActivityCollegeSyllabusPdfBinding.inflate(getLayoutInflater());
    ...
    private void setUpFirebase() {
        myLoaders.settingUpLoader(CollegeSyllabusPDF.this);
        myRef = FirebaseDatabase.getInstance().getReference("PDF");

        myRef.child(finalCourseName).child(finalBranch).child(finalType).child("allSyllabus").child("completeSyllabus").
